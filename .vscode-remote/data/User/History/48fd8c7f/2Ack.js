...
module.exports = function (app) {
  ...
  app.route('/api/check')
    .post((req, res) => {
      ...
      let rower = solver.checkRowPlacement(req.body.puzzle, coordinate, value);
      let coller = solver.checkColPlacement(req.body.puzzle, coordinate, value);
      let regioner = solver.checkRegionPlacement(req.body.puzzle, coordinate, value);
